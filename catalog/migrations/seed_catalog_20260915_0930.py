...
class Migration(migrations.Migration):
    ...
    # FIXME: remove assert False and replace "000X_YOUR_MOST_RECENT_MIGRATION_NAME" with the name of
    # your most recent migration file in the dependencies list below before running this migration
